...
public class PostDto {
    ...
    private UserDto user;   //here i am not write like that ...private User user i dont want to sent whole user i only want to sent userId relating to it

    private CateogaryDto cateogary;   // same here for caterogary
